...
// (i1,i2), where i1 represents a child node in
// a tree and the second integer i2 signifies that
...
// Your program should, in this case, return the string true
// because a valid binary tree can be formed.
// If a proper binary tree cannot be formed with
// the integer pairs, then return the string false.
// All of the integers within the tree will be unique,
// which means there can only be one node in the tree with
